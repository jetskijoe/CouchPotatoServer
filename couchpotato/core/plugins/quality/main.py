...
class QualityPlugin(Plugin):
    ...
    qualities = [
        ...
        {'identifier': 'scr', 'size': (600, 10000), 'median_size': 5500, 'label': 'Screener', 'alternative': ['screener', 'web-dl', 'webdl', 'dvdscr', 'ppvrip', 'dvdscreener', 'hdscr', 'webrip', ('web', 'rip')], 'allow': [], 'ext':[], 'tags': []},
