...
class QualityPlugin(Plugin):
    ...
    qualities = [
        ...
        {'identifier': 'brrip', 'hd': True, 'allow_3d': True, 'size': (700, 7000), 'median_size': 2000, 'label': 'BR-Rip', 'alternative': ['bdrip', ('br', 'rip'), 'hdtv', 'hdrip'], 'allow': ['720p'], 'ext':['mp4', 'avi', 'mkv'], 'tags': []},
        ...
        {'identifier': 'scr', 'size': (600, 7000), 'median_size': 1500, 'label': 'Screener', 'alternative': ['screener', 'dvdscr', 'ppvrip', 'dvdscreener', 'hdscr', 'webrip', ('web', 'rip')], 'allow': ['dvdr', 'dvdrip', '720p', '1080p'], 'ext':[], 'tags': ['webdl', ('web', 'dl')]},
